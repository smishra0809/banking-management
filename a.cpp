...
class Bank{                   //define bank class
	...
	int acno,balance;
	public :
		bool type(string ac){          // function for deposite balance according to actype  
			if(ac=="saving"){
		...
		bool openaccount(int i){               //function for open account  it return true if all detail is correct else return false 
			...
			switch(choice){
			    ...
			    case 2 : actype ="current";
			      break ;
			    default : cout<<"select correct choice ";
			        goto typ;
		...
		void deposite(){
			...
			cin>>choice ;
			switch(choice){
				case 1: cout<<"By check"<<endl;
				break;
				case 2 : cout<<"By NEFT"<<endl;
				 break;
				case 3: cout<<"By cash"<<endl;
				 break;
				 default:
		 ...
		 case 6:
			...
			if(b.find(acno)!=b.end()){
			    ...
			    if(pin==p[acno]){
				   ...
				   cin>>p1;
				   p[acno]=p1;
				   cout<<endl<<"your pin is successfully changed"<<endl;
			    }
			}
			    else{
			        cout<<"Incorrect pin "<<endl;
